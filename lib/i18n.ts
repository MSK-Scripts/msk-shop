...
export const giveawayDashboardTranslations = {
  en: {
    ...
    elig_hint:      'These come on top of the server settings: role lists are merged, bonus entries are added up.',
  ...
  de: {
    ...
    elig_hint:      'Sie kommen zu den Server-Einstellungen dazu: Rollenlisten werden vereinigt, Bonus-Lose addiert.',
