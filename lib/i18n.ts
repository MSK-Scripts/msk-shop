...
export const dashboardTranslations = {
  en: {
    ...
    host_failed_hint:     'Almost always a wrong value below. Correct it and save, the bot is reinstalled only if that is really necessary.',
  ...
  de: {
    ...
    host_failed_hint:     'Fast immer ist ein Wert unten falsch. Korrigiere ihn und speichere, neu installiert wird nur wenn es wirklich nötig ist.',
