...
const FEATURES = [
  ...
  { icon: Shield,       title: 'Eligibility Rules',   text: 'Whitelist and blacklist roles, server-wide or scoped to a single giveaway, plus minimum account age and server membership.' },
  { icon: PauseCircle,  title: 'Pause & Resume',      text: 'Freeze the timer mid-giveaway if something goes wrong, then resume it where you left off.' },
  { icon: Layers,       title: 'Templates',           text: 'Save and reuse giveaway configurations for recurring weekly or event giveaways.' },
      ...
      <section className="container-page py-14 md:py-20">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm text-[var(--color-muted-foreground)] md:text-base">
            No server, no database and no config files. Just invite the bot and go.
          </p>
        </div>
