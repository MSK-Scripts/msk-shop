...
function FooterLink({ href, external, children }: { href: string; external?: boolean; children: React.ReactNode }) {
  // `min-h-11` statt `py-1`: die Links standen auf 32 px Zeilenhöhe, am
  // Telefon zu wenig. Flex statt Block, damit der Text mittig bleibt.
  const cls = 'flex min-h-11 items-center text-sm text-[var(--color-muted-foreground)] transition-colors hover:text-[var(--color-foreground)]'
      ...
      <div className="container-page py-12">
        <div className="flex flex-col gap-10 lg:flex-row lg:justify-between">
          ...
          <div className="max-w-sm">
            <Link href="/" className="tap-target inline-flex items-center gap-2 font-bold">
            ...
            <div className="mt-4 flex gap-2">
              ...
              <Button asChild variant="outline" size="sm" className="tap-target" aria-label="GitHub">
