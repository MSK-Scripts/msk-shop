...
import type { CustomPackage } from '@/content/custom-packages'

/**
 * Karte für einen Eintrag aus `CUSTOM_PACKAGES`.
 *
 * Liegt in einer eigenen Datei, weil sie inzwischen von zwei Sektionen benutzt
 * wird: den kostenlosen FiveM-Scripts und den Web-Tools. Vorher stand das
 * Markup nur in `CustomPackages.tsx`; ein zweiter Aufrufer hätte es kopiert und
 * beide wären auseinandergelaufen.
 */
...
export function CustomPackageCard({ pkg }: { pkg: CustomPackage }) {
  return (
