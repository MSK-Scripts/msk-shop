...
- **(d)** Pull Requests einzureichen, die dem Projekt eindeutig zugutekommen, wobei eingebrachte Beiträge vollständig auf den Urheber übergehen (siehe § 5).
...
Jede vollständige oder teilweise Vervielfältigung des Quellcodes, der Designs, der Benutzeroberflächen oder der Logik, egal ob wortgetreu oder in abgewandelter Form.
...
- **(c)** erwirbst du durch deinen Beitrag keine Lizenz an oder Eigentumsrechte am Projekt selbst, die über die in § 2 beschriebenen Rechte hinausgehen.
...
- **7.1** Bei einem Verstoß gegen diese Lizenz erlöschen alle gemäß § 2 gewährten Rechte **automatisch und ohne Vorankündigung**.
...
- **8.3** Sollte eine Bestimmung dieser Lizenz unwirksam sein, bleibt die Wirksamkeit der übrigen Bestimmungen unberührt. Die unwirksame Bestimmung wird durch eine wirksame ersetzt, die ihrem wirtschaftlichen Zweck am nächsten kommt **(salvatorische Klausel)**.
