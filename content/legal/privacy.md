...
Further information: [netcup Privacy Policy](https://www.netcup.com/en/contact/data-privacy).
...
- **GitHub username** — collected via GitHub OAuth during the verification process, for identity and sponsorship verification
...
- **Subscription tier** — determined based on GitHub Sponsors status (Basic, Premium, Premium+)
...
- **Ticket transcript content** — HTML files generated by the bot and uploaded to our server; stored for 30–120 days depending on tier
...
- **GitHub sponsorship data** — received via GitHub Sponsors webhook (GitHub username and tier); processed to activate or update the subscription
...
| `msk_verify_session` | Stores verified GitHub username and Discord server list | 1 hour |
...
**GitHub OAuth:** You are redirected to GitHub and authorise our application. GitHub then transmits your GitHub username to us. This is stored temporarily in a signed session cookie and, after completing the verify flow, permanently in our database.
...
Transcripts are automatically deleted after the retention period applicable to your tier (30, 60, or 120 days). Transcripts are publicly accessible via their unique URL (containing a random UUID), but are not indexed or linked.
...
We operate a webhook endpoint that receives events from **GitHub Sponsors** when you start, change, or cancel a sponsorship. The event contains your GitHub username and the monthly amount. We process this data to automatically activate, upgrade, or downgrade your subscription tier.

**Data processed:** GitHub username, subscription tier (derived from the monthly amount), action (created/cancelled/tier_changed).
...
- [Tebex Terms of Service](https://checkout.tebex.io/terms)

---

## Subscription Payments (GitHub Sponsors)
...
GitHub Sponsors handles all payment processing, invoicing, and refunds. We only receive your GitHub username and the subscription tier via webhook — no payment data.

GitHub Privacy Policy: [docs.github.com/site-policy](https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement)
...
**GitHub, Inc.** (USA): GitHub Sponsors and OAuth services are operated by GitHub. Transfers are made on the basis of Standard Contractual Clauses. See: [github.com/site-policy](https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement)
