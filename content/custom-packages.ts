...
export const CUSTOM_PACKAGES: CustomPackage[] = [
  ...
  },
  {
    ...
    description: 'A multilingual, per-guild configurable giveaway bot built on Discord.js v14. Restart-safe scheduling, weighted bonus entries, eligibility rules, templates and pause/resume functionality.',
    price: 'Free',
    isFree: true,
    image: 'msk_giveawaybot_banner.png',
  ...
  },
  {
    id: 'forms',
    name: 'MSK Forms',
    description: 'A modern form & application platform with status feedback and native Discord integration.',
    image: 'msk_forms.png',
