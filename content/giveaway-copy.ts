...
const en: GiveawayCopy = {
  ...
  features: [
    ...
    { title: 'First Click Wins',        text: 'For the quick ones: a crate key, an event reward. Instead of a draw, the fastest button press takes the prize and the giveaway ends right there. The duration stays as a deadline in case nobody clicks.' },
    { title: 'Weighted Bonus Entries',  text: 'Grant specific roles extra entries (up to 100), shown right in the giveaway message so everyone knows about them.' },
    { title: 'Eligibility Rules',       text: 'Whitelist and blacklist roles plus minimum account age and server membership. Set them server-wide, and let a single giveaway use its own rules instead.' },
    { title: 'Pause & Resume',          text: 'Freeze the timer mid-giveaway if something goes wrong, then resume it where you left off.' },
    { title: 'Templates',               text: 'Save any giveaway as a template with one click, including prizes and entry conditions, then start the next one from it with every field already filled in.' },
    ...
    { title: 'Tebex Winner Coupons',    text: 'Connect your own Tebex store and every winner automatically receives their own single-use discount code by DM, optionally limited to selected packages, and to different packages per winner. Codes from a partner’s shop can be entered by hand for a joint giveaway.' },
    { title: 'Multilingual',            text: 'English, German, French, Spanish, Hungarian, Polish and Portuguese built in. Pick the language per server.' },
  ...
  commandText: [
    'Open a modal and create a giveaway in the current channel. The mode option switches to one prize per winner, the draw option to first click wins.',
    'Edit a running giveaway (title, description, winners, prizes, winner selection).',
    ...
    'Save, list, delete or use giveaway templates, or turn an existing giveaway into one.',
  ...
  settings: [
    ...
    { title: 'Language',    text: 'Switch the bot UI between English, German, French, Spanish, Hungarian, Polish and Portuguese.' },
    { title: 'Eligibility', text: 'Whitelist & blacklist roles and bonus entries, plus minimum account and membership age. A single giveaway can carry its own set, which then applies instead of the server one.' },
...
const de: GiveawayCopy = {
  ...
  features: [
    ...
    { title: 'Wer zuerst klickt, gewinnt', text: 'Für die schnellen Sachen: ein Crate Key, ein Event-Preis. Statt einer Ziehung bekommt der schnellste Knopfdruck den Preis, und das Gewinnspiel ist damit vorbei. Die Laufzeit bleibt als Frist, falls niemand klickt.' },
    { title: 'Gewichtete Bonuslose',    text: 'Bestimmten Rollen zusätzliche Lose geben (bis zu 100), sichtbar im Giveaway selbst, damit jeder davon weiß.' },
    { title: 'Teilnahmeregeln',         text: 'Rollen auf die Whitelist oder Blacklist setzen, dazu Mindestalter des Accounts und der Servermitgliedschaft. Serverweit, und ein einzelnes Gewinnspiel darf eigene Regeln nutzen.' },
    ...
    { title: 'Vorlagen',                text: 'Jedes Gewinnspiel mit einem Klick als Vorlage sichern, samt Preisen und Teilnahmeregeln, und das nächste daraus starten, mit allen Feldern schon ausgefüllt.' },
    ...
    { title: 'Tebex-Gutscheine',        text: 'Verbinde deinen eigenen Tebex-Store und jeder Gewinner erhält automatisch seinen persönlichen Einmal-Gutschein per DM, auf Wunsch nur für ausgewählte Pakete, und je Gewinner für andere. Codes aus dem Shop eines Partners lassen sich für ein gemeinsames Gewinnspiel von Hand eintragen.' },
    { title: 'Mehrsprachig',            text: 'Englisch, Deutsch, Französisch, Spanisch, Ungarisch, Polnisch und Portugiesisch sind eingebaut. Die Sprache wird pro Server gewählt.' },
  ...
  commandText: [
    'Öffnet ein Modal und erstellt ein Gewinnspiel im aktuellen Kanal. Die Option mode stellt auf einen Preis pro Gewinner um, die Option draw darauf, dass der schnellste Klick gewinnt.',
    'Bearbeitet ein laufendes Gewinnspiel (Titel, Beschreibung, Gewinner, Preise, Gewinner-Ermittlung).',
    ...
    'Vorlagen speichern, auflisten, löschen oder verwenden, oder ein bestehendes Gewinnspiel als Vorlage sichern.',
  ...
  settings: [
    ...
    { title: 'Sprache',          text: 'Die Bot-Oberfläche zwischen Englisch, Deutsch, Französisch, Spanisch, Ungarisch, Polnisch und Portugiesisch umschalten.' },
    { title: 'Teilnahme',        text: 'Whitelist- und Blacklist-Rollen sowie Bonuslose, dazu Mindestalter von Account und Mitgliedschaft. Ein einzelnes Gewinnspiel kann eigene Regeln tragen, die dann statt der serverweiten gelten.' },
