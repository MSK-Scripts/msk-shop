...
const en: GiveawayCopy = {
  ...
  features: [
    ...
    { title: 'Templates',               text: 'Save a whole giveaway including its prize list, then start the next one from it in the dashboard with every field already filled in.' },
  ...
  settings: [
    ...
    { title: 'Eligibility', text: 'Whitelist & blacklist roles and bonus entries, server-wide or per giveaway, from the dashboard or by command, plus minimum account and membership age.' },
...
const de: GiveawayCopy = {
  ...
  features: [
    ...
    { title: 'Vorlagen',                text: 'Ein ganzes Gewinnspiel samt Preisliste speichern und das nächste im Dashboard daraus starten, mit allen Feldern schon ausgefüllt.' },
  ...
  settings: [
    ...
    { title: 'Teilnahme',        text: 'Whitelist- und Blacklist-Rollen sowie Bonuslose, serverweit oder pro Gewinnspiel, im Dashboard oder per Befehl, dazu Mindestalter von Account und Mitgliedschaft.' },
